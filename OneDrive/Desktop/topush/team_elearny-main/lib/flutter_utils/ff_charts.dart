...
class FFLineChart extends StatelessWidget {
  const FFLineChart({
    Key? key,
    required this.data,
...
class FFBarChart extends StatelessWidget {
  const FFBarChart({
    Key? key,
...
class FFPieChart extends StatelessWidget {
  const FFPieChart({
    Key? key,
    required this.data,
...
class FFChartLegendWidget extends StatelessWidget {
  const FFChartLegendWidget({
    Key? key,
