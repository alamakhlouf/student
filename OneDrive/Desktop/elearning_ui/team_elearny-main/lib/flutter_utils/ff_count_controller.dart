...
class FFCountController extends StatefulWidget {
  const FFCountController({
    Key? key,
  ...
  @override
  _FFCountControllerState createState() =>
      _FFCountControllerState();
}

class _FFCountControllerState
    extends State<FFCountController> {
